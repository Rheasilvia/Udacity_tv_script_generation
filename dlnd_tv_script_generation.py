...
def get_embed(input_data, vocab_size, embed_dim):
    ...
    """
    # TODO: Implement Function
    embedding = tf.Variable(tf.random_uniform((vocab_size,embed_dim),-1,1))#均匀分布,-1,1之间
...
def get_tensors(loaded_graph):
    ...
    initalState = loaded_graph.get_tensor_by_name('initial_state:0')
    finalState = loaded_graph.get_tensor_by_name('final_state:0')
    probs = loaded_graph.get_tensor_by_name('probs:0')
    
    return (inputTensor, initalState, finalState, probs)
